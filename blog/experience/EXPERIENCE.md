...
- 2026 NAVER Cloud Academy 소버린 AI Literacy 과정 1기 참가(/Users/hyunwoo/Desktop/project/portfolio/blog/experience/네이버클라우드\_발표자료.pdf)
- 2026 Wrtn AI 개발자 양성 부트캠프 참가(https://github.com/ihyonoo/ai-job-matching-system)
- 2026 로컬 창업동아리 아이디어 리그 경진대회 참가(/Users/hyunwoo/Desktop/project/portfolio/blog/experience/idea-league-slides.pdf)
...
### RTSP 기반 22대 CCTV 실시간 수집 시스템 구축
...
### 꼬마선충(C. elegans) 객체 탐지 및 트래킹 모델 구현
...
### 가스공사 검침원 촬영 사진 기반 보일러 연통 자동 탐지 시스템 구축

- 보일러/비보일러 이진 분류 모델(ResNet18) 개발 및 성능 분석 진행
- 연통(보일러 배출구) 객체 탐지 모델(YOLO11n) 개발 및 성능 분석 진행
- 2단계(분류 → 탐지) 연계 추론 파이프라인 구현

### Azure OpenAI API를 활용한 TBM(Tool Box Meeting, 작업 전 안전점검) 문서 자동 생성 시스템 개발
